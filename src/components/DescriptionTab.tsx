...
export const DescriptionTab = () => {
  ...
  return (
    <div className="mt-4">
      <label
        className={clsx("block text-sm mb-2", theme === "dark" ? "text-gray-300" : "text-gray-700")}
      >
        Request Description
      </label>
      <textarea
        ...
        rows={8}
        className={clsx(
          "w-full p-3 border rounded-xl text-sm resize-none focus:outline-none",
          theme === "dark"
          ...
          <div>
            ...
            <div
              className={clsx(
                ...
                theme === "dark" ? "bg-gray-800 text-gray-300" : "bg-white text-gray-700 border"
              )}
            >
              "Fetches user profile data for the dashboard.
              <br />
      ...
      {description && (
        <div className={clsx("mt-3 text-xs", theme === "dark" ? "text-gray-500" : "text-gray-600")}>
