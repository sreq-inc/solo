...
import { Minus, Square, SquaresSubtract, X } from "lucide-react";
    ...
    <>
      ...
      <section className="h-full grid grid-cols-3 items-center">
        <button
          ...
          className="h-full flex items-center justify-center bg-transparent px-4 hover:bg-neutral-500/10"
        >
          <Minus size={12} />
        </button>
        <button
        ...
        <button
          onClick={closeWindow}
          className="h-full flex items-center justify-center bg-transparent px-4 hover:bg-red-600"
        >
          <X size={16} />
        </button>
      </section>
